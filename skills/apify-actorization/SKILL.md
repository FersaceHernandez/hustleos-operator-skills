...
- **JavaScript/TypeScript**: See [references/js-ts-actorization.md](references/js-ts-actorization.md)
- **Python**: See [references/python-actorization.md](references/python-actorization.md)
- **Other Languages (CLI-based)**: See [references/cli-actorization.md](references/cli-actorization.md)
...
See [references/schemas-and-output.md](references/schemas-and-output.md) for detailed configuration of:
